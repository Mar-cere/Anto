...
- **BA (#88):** plan semanal, tendencia de ánimo en registros, sync tarea/hábito ↔ slot al cargar plan.
...
- Paridad socket (chat principal usa SSE).
- Módulos micro-guía #90–#99 con pantallas dedicadas.
