...
Listado de **~182** propuestas `No` en la tabla principal, más **6** filas **`Parcial`** con trabajo abierto — núcleo **crisis** (**#9**, **#10**, **#93**, **#205**; spec [PROTOCOLO_CRISIS_V1.md](./PROTOCOLO_CRISIS_V1.md); releases **1.5.0** / **1.5.1**), i18n (**#151**) y límites IA (**#194**) — y **8 anclas entregadas** referenciadas (numeración **#1–#223**; huecos históricos conservados; **16** ex-Q5 + **11** entregadas archivadas). **Hecha:** `Sí` / `Sí*` / `Parcial` = ver columna. Chat → tarea/hábito: [CONTRATO_CHAT_ACCIONES_V1.md](./CONTRATO_CHAT_ACCIONES_V1.md). Crisis → [PROTOCOLO_CRISIS_V1.md](./PROTOCOLO_CRISIS_V1.md).
...
| **Crisis 1.5.0 (#205, #9, #10, #93)** | **Parcial:** ingeniería camino A/B, panel, ops. **Spec producto (30 jun 2026):** [PROTOCOLO_CRISIS_V1.md](./PROTOCOLO_CRISIS_V1.md) — 4 pilares (contención, recursos, acompañamiento, alertas híbridas opción C), batería explícita (ideación, autolesión, adicción en crisis, etc.), salida 2 turnos estables o confirmación usuario, transparencia siempre visible (#10), **sin** guía buscar profesional (#9) en v1. **Pendiente cierre:** firma clínica/legal, checklist §8 del protocolo (MEDIUM preguntado, `crisis_protocol_exit`, copy T1–T5 en panel). |
...
| 10 | Transparencia crisis | Explicación en lenguaje llano del «por qué» en modo crisis. **Spec v1:** bloques T1–T5 **siempre visibles** en panel ([PROTOCOLO_CRISIS_V1.md](./PROTOCOLO_CRISIS_V1.md) §6); post-envío alertas §5.3. **Pendiente implementación:** checklist §8; EN completo (#151). | Parcial | 4 | 5 | 4 | 5 | B | S | Q1 |
...
| 93 | Protocolo ideación (seguridad) | Flujo fijo: validación, seguridad, recursos, acompañamiento, alertas híbridas. **Spec v1 (30 jun 2026):** [PROTOCOLO_CRISIS_V1.md](./PROTOCOLO_CRISIS_V1.md) — batería explícita, salida 2 turnos, rama rechazo derivación. **Estado:** spec producto; **pendiente** firma clínica/legal + checklist implementación §8. | Parcial | 4 | 5 | 5 | 5 | A | M | Q1 |
...
| 205 | Guardrails crisis (hard-stop) | Routing de riesgo: camino A (plantilla) + camino B (LLM blindado). **Parcial:** código 1.5.0 + [PROTOCOLO_CRISIS_V1.md](./PROTOCOLO_CRISIS_V1.md). **Pendiente cierre producto:** salida `crisis_protocol_exit`, alertas MEDIUM preguntadas, copy T1–T5 siempre visible, firma clínica/legal de #93. | Parcial | 4 | 5 | 5 | 5 | M | M | Q1 |
...
*Puntuaciones orientativas. Última revisión: **30 jun 2026** (spec [PROTOCOLO_CRISIS_V1.md](./PROTOCOLO_CRISIS_V1.md): batería crisis, alertas híbridas opción C, salida 2 turnos, #93 → Parcial; parciales abiertos: **#9**, **#10**, **#93**, **#205**, **#151**, **#194**).*
