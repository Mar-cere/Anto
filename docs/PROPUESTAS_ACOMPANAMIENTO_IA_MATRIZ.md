...
| **Psicoeducación modular (#85)** | **Parcial (~90% jun 2026):** 9 módulos es/en (incl. duelo, burnout), biblioteca, tarjetas interactivas en chat (#78 microSteps), tests/smoke. **Pendiente:** **#111** sello clínico ampliado. |
