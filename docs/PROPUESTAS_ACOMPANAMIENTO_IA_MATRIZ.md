...
| **Grafo tema–intervención (#127)** | **Parcial (~90% jun 2026):** catálogo (#85–#89 + grief/burnout), eventos `shown` en continuidad, ranking visible en chips («ordenadas según tu historial»), sesión 45 min, políticas chat TCC. **Pendiente:** `topicFree`, #218, datos reales en prod. |
