...
| **TCC lite in-chat (#201)** | **Sí* (jun 2026):** 4 pasos, pie progreso en burbuja (SSE metadata), estado `tccLiteState`, handoff AT, resume session insight, paridad socket↔SSE (`chatTransportTccLiteParity`), smoke `test:tcc-lite-suite`. |
...
| 201 | Marco TCC guiado en chat | Restringir divagación del LLM con **marco clínico TCC**: detectar distorsiones en texto del usuario (catastrofización, todo/nada, etc.), guiar reestructuración **paso a paso** in-chat (no solo consejo genérico). **Cerrado (jun 2026):** TCC lite 4 pasos, pie en burbuja (metadata SSE), handoff AT, resume insight, paridad transportes, `test:tcc-lite-suite`. Complementa **#40**, **#89**, **#86**. | Sí* | 3 | 5 | 5 | 5 | M | L | Q2 |
