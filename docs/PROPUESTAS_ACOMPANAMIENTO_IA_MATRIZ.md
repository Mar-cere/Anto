...
| **i18n UI EN (#151)** | **Parcial:** `LanguageContext`, selector en Ajustes, diccionarios `es`/`en` (~2.1k+ claves c/u), wizards TCC y psicoed bilingües. **Avance jun 2026:** campaña email **1.5.0** con copy humano; enlaces Instagram por idioma; recordatorio verificación email. **Revisión legal aprobada (30 jun 2026).** **Pendiente:** push multilingüe, prompts chat/crisis backend (**#153**), revisión nativa EN. |
