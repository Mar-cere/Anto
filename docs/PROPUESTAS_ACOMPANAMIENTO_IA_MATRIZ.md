...
Listado de **200** ideas. **Hecha:** `Sí` = entregado; `Sí*` = entregado, pendiente cerrar métricas o calibración; `Parcial` = MVP parcial; `No` = sin implementación relevante. Chat → tarea/hábito: [CONTRATO_CHAT_ACCIONES_V1.md](./CONTRATO_CHAT_ACCIONES_V1.md).
...
| 8 | Panel qué hace la IA | Copy corto desde chat y ajustes: límites, expectativas, honestidad del producto. | No | 4 | 5 | 3 | 4 | B | S | Q1 |
...
| 14 | Compartir resumen confianza | Opt-in para enviar solo resumen semanal o de foco a un contacto (no red social). | No | 2 | 3 | 3 | 3 | A | L | Q4 |
...
| 16 | Onboarding acompañamiento | Primera experiencia = conversación y expectativas del acompañamiento antes que hábitos o paywall duro... | Sí | 4 | 5 | 4 | 5 | M | M | Q1 |
...
| 21 | Rama por tema | Mantener perfil y foco pero abrir hilo nuevo por tema (duplicar contexto sin mezclar todo). | No | 2 | 3 | 3 | 3 | M | M | Q4 |
...
| 27 | Logros proceso | Insignias por constancia de sesiones, honestidad en check-in, no solo rachas superficiales. | No | 1 | 2 | 3 | 3 | B | M | Q4 |
...
| 31 | Espacio entre sesiones | Mensajes breves opcionales entre recordatorios (cita tipo CBT entre semana) con copy no intrusivo. | Parcial | 2 | 3 | 5 | 4 | M | M | Q2 |
...
| 37 | Síntesis colapsable IA | La IA ofrece “en 2 líneas” arriba del mensaje largo; el detalle queda expandible. | No | 2 | 3 | 3 | 3 | M | M | Q4 |
...
| 56 | Pipeline entender → responder | Paso interno de clasificación o extracción (intención, emoción, urgencia) y luego generación de respuesta; reduce respuestas desalineadas al mensaje real. | Sí | 3 | 5 | 4 | 5 | M | M | Q2 |
| 57 | Pregunta si baja certeza | Si el modelo estima ambigüedad o baja confianza interpretativa, **preguntar** en lugar de asumir (certeza honesta por turno). | Sí | 3 | 5 | 4 | 5 | B | M | Q2 |
...
| 62 | Plantilla validación–normalización–pregunta | Estructura mínima en respuestas sensibles: validar sentir, normalizar sin minimizar, **una** pregunta abierta concreta (evita muros de texto genéricos). | Sí | 3 | 5 | 5 | 5 | M | M | Q2 |
...
| 72 | Intención de sesión al inicio | Pregunta única al abrir: desahogar / ordenar pensamiento / técnica / planificar — ajusta estilo, longitud y ratio consejo/escucha para toda la sesión... | Sí | 3 | 5 | 4 | 5 | M | S | Q2 |
...
| 78 | Tarjetas psychoed nativas | Componentes RN (pasos, iconografía, CTA “probar 1 min”) disparados desde plantillas del modelo; diferenciación frente a chat plano de competencia. | No | 3 | 5 | 4 | 5 | M | L | Q2 |
...
| 83 | Timeline / minimapa sesión | Barra o minimapa vertical para saltar a un turno; sincronizado con scroll del FlatList; alto brillo técnico con coste de implementación acotado si es MVP. | No | 2 | 3 | 3 | 3 | M | M | Q4 |
...
| 85 | Psicoeducación modular evidencia | Módulos breves (ansiedad, depresión, ira, sueño, trauma informado) con fuentes y lenguaje no diagnóstico; activables desde chat o biblioteca. | No | 2 | 4 | 4 | 4 | M | M | Q2 |
| 86 | Autorregistro ABC | Flujo guiado in-app o desde el chat para patrones conductuales; export opcional para terapeuta humano. | No | 3 | 5 | 4 | 5 | M | M | Q2 |
...
| 89 | Pensamientos automáticos CBT | Detectar y nombrar cogniciones con vocabulario CBT estándar + enlace a distorsiones ya existentes en el producto. | No | 3 | 5 | 4 | 5 | M | M | Q2 |
...
| 110 | Cohortes idioma/región | Mismo módulo psicoed (#85) con recursos locales, tono cultural y líneas de ayuda correctas por jurisdicción. | No | 2 | 3 | 3 | 3 | M | M | Q4 |
| 111 | Sello revisión clínica por versión | Governance visible: qué versión de qué módulo (#85–#99) pasó revisión; alinea marketing y compliance interno. | No | 2 | 4 | 3 | 4 | M | M | Q2 |
...
| 113 | RAG corpus curado | Vector store (p. ej. Atlas Vector, pgvector, Qdrant) con chunks de protocolos, psychoed revisada y políticas de crisis; recuperación por `conversationId` + tema, no web abierta. | No | 3 | 5 | 4 | 5 | A | L | Q2 |
| 114 | Routing modelos triage | Llamada ligera (modelo pequeño o reglas) para intención/urgencia/RAG sí-no; modelo principal solo cuando hace falta; reduce coste y TTFT... | Sí* | 3 | 4 | 4 | 4 | M | M | Q2 |
...
| 119 | Dataset eval + CI regresión | Conversaciones golden + asserts automáticos (no minimización ideación, tono); gate en merge a `main` para prompts sensibles. | Sí* | 3 | 5 | 3 | 4 | M | L | Q2 |
...
| 122 | Caché semántica estática | Embeddings de FAQs y módulos #85 no PII; TTL y invalidación por versión de corpus; **no** cachear mensajes íntimos del usuario. | No | 2 | 3 | 2 | 3 | M | M | Q4 |
...
| 137 | API partner EAP | Endpoints de resumen agregado o booking con OAuth; rate limits y scopes; **#137** en backlog si no hay partner aún (**Q4** operativo). | No | 2 | 3 | 2 | 3 | A | L | Q4 |
...
| 139 | Chaos dependencias | Inyección de fallos Redis/OpenAI en entorno controlado; valida circuit breakers y degradación (#123, #131). | No | 2 | 3 | 3 | 3 | M | M | Q4 |
...
| 146 | SLA interno por tier | Objetivos de uptime y latencia p95 por plan; alinea expectativas comerciales con **#131**. | No | 2 | 3 | 3 | 3 | M | S | Q4 |
| 147 | Bug bounty / disclosure | Canal seguro para investigadores; complementa **#129**. | No | 2 | 3 | 2 | 3 | A | L | Q4 |
...
| 150 | Cómputo verde / región baja CO₂ | Elegir regiones de inferencia con electricidad baja carbono donde el proveedor lo permita; métrica estimada por millón de tokens (comunicación honesta). | No | 1 | 2 | 2 | 2 | B | S | Q4 |
| 151 | Inglés EN producto fase 1 | Cadenas de **UI**, emails transaccionales, errores y copy legal/privacidad en **inglés**; selector de idioma en perfil; pruebas con hablantes nativos o revisión profesional. | No | 3 | 5 | 5 | 5 | M | L | Q2 |
...
| 153 | Chat IA multilingüe ES/EN/PT | Preferencia de idioma en perfil + **detección opcional** del idioma del mensaje; **system prompts y recursos de crisis** versionados por locale; alinea con **#133** (i18n profundo) y **#110** (cohortes por región/idioma). | No | 3 | 5 | 5 | 5 | M | L | Q2 |
| 154 | Informe ampliado entre consultas | Evolución de **#11**: síntesis de **temas tratados en sesiones**, **autoinforme** del usuario y señales **observables** (hábitos, tareas, escalas si existen) para describir **qué ocurre fuera del consultorio humano**; lenguaje de **temas… | No | 3 | 5 | 5 | 5 | A | L | Q2 |
...
| 158 | Hero retoma tu hilo | Al abrir la app tras 24–72 h, bloque que resume **último tema** y último mensaje propio; reduce fricción cognitiva y abandono silencioso. | No | 3 | 4 | 4 | 4 | B | S | Q2 |
...
| 162 | Ritual celebración proceso | Tras **N** intercambios reflexivos (no “puntos”), copy y animación sutil que valida esfuerzo; alternativa sana a **#27**. | No | 2 | 3 | 4 | 4 | B | S | Q2 |
...
| 173 | Knip código muerto | Limpieza periódica de exports y archivos huérfanos; reduce superficie y confusión en onboarding dev. | No | 2 | 3 | 2 | 3 | B | S | Q4 |
...
| 188 | Copy remoto server-driven | Hotfix de copy legal/terapéutico sin store release; feature flag; riesgo de consistencia offline. | No | 2 | 3 | 3 | 3 | M | M | Q4 |
...
| 191 | Mecanismo de cambio one-liner | Tras micro-guías (**#78**, **#85**), una frase tipo “por qué esto ayuda” basada en evidencia genérica. | No | 2 | 4 | 4 | 4 | M | M | Q2 |
...
| 194 | Biblioteca límites competencia IA | Pantallas y tooltips: **qué no hace** la app, cuándo **#9**, crisis **#10**; reduce expectativas mágicas. | No | 4 | 4 | 4 | 4 | M | M | Q1 |
| 195 | Diario sueño-vigilia UX | UX de registro simple acoplado a **#95** y resúmenes semanales (**#11**, **#154**). | No | 3 | 4 | 4 | 4 | M | M | Q2 |
| 196 | Mutación tests pago/token | Stryker o similar en módulos críticos de facturación y sesión; alto coste, priorizar si hay checkout. | No | 2 | 4 | 2 | 3 | A | L | Q4 |
...
*Puntuaciones orientativas. Mayo 2026.*
