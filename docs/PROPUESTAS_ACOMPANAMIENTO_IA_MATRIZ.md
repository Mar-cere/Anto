...
| 78 | Tarjetas psychoed nativas | Componentes RN (pasos, iconografía, CTA “probar 1 min”) disparados desde plantillas del modelo; diferenciación frente a chat plano de competencia. **Parcial:** `PsychoeducationSuggestionCard` en chat para sugerencias #85 (resumen, mecanismo, CTA ~2 min). **Pendiente:** disparo desde plantillas LLM, pasos in-chat. | Parcial | 3 | 5 | 4 | 5 | M | L | Q2 |
