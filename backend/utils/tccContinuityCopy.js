...
const COPY = {
  es: {
    ...
    atIncompleteTitle: 'Pensamiento automático · Completar',
    atIncompleteSuffix: 'Falta pensamiento alternativo',
    abcRecentTitle: 'Autorregistro ABC · Reciente',
  ...
  en: {
    ...
    atIncompleteTitle: 'Automatic thought · Complete',
    atIncompleteSuffix: 'Balanced thought missing',
    abcRecentTitle: 'ABC record · Recent',
