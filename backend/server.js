...
import dailyMoodRoutes from './routes/dailyMoodRoutes.js';
...
app.use('/api/clinical-scales', clinicalScalesRoutes);
app.use('/api/cognitive-distortions', cognitiveDistortionsRoutes);
