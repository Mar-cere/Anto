...
class EmotionalAnalyzer {
  constructor() {
    ...
    this.emotionPatterns = {
      tristeza: {
        patterns: /(?:triste(?:za)?|deprimi(?:do|da|r)|sin energía|desánimo|desmotiva(?:do|da|r)|(?:^|[^a-z])(?:solo|soledad)(?:[^a-z]|$)(?!.*estoy.*bien)(?!.*me.*siento.*bien)(?!.*todo.*bien)|melancolía|nostalgia|abatid(?:o|a)|desesperanzad(?:o|a)|desconsolad(?:o|a)|llor(?:o|ar|ando)|\bllanto\b|\bvacío\b|vacío interior|sin ganas|sin ánimo|desgana|apático|apatía|hundid(?:o|a)|caíd(?:o|a)|desilusionad(?:o|a)|desencantad(?:o|a)|no.*tengo.*ganas|no.*me.*motiva|me.*siento.*mal(?!.*genial)(?!.*bien)|no.*me.*siento.*bien|estoy.*mal(?!.*genial)(?!.*bien)|me.*va.*mal|me.*siento.*peor|estoy.*peor|peor.*que|me.*siento.*peor.*que|estoy.*peor.*que|peor.*que.*antes|estoy.*peor.*que.*antes|me.*siento.*peor.*que.*antes|tengo.*ganas.*de.*hacerme.*daño|quiero.*hacerme.*daño|me.*quiero.*cortar|quiero.*cortarme|me.*corto|me.*quemo|me.*golpeo|autolesi(?:ón|on|arme)|hacerme.*daño|hacerse.*daño|el.*dolor.*físico.*me.*hace.*sentir.*mejor.*que.*el.*dolor.*emocional|cicatrices.*de.*cuando.*me.*cortaba|necesito.*hacerme.*daño|urgencia.*de.*hacerme.*daño|no.*puedo.*dejar.*de.*pensar.*en.*hacerme.*daño|pensar.*en.*hacerme.*daño|sería.*mejor.*si.*no.*existiera|mejor.*si.*no.*existiera|pienso.*que.*sería.*mejor.*si.*no.*existiera|terminar.*con.*todo.*esto|pensado.*en.*cómo.*terminar|nadie.*me.*extrañaría.*si.*me.*fuera|me.*extrañaría.*si.*me.*fuera|no.*veo.*ninguna.*salida|sin.*salida|futuro.*se.*ve.*completamente.*negro|futuro.*negro|mi.*vida.*no.*puedo.*ser.*peor|mi.*vida.*no.*puede.*ser.*peor|ya.*no.*puedo.*más.*estoy.*al.*límite|estoy.*al.*límite|me.*siento.*desconectado.*de.*todos|desconectado.*de.*todos|estoy.*hecho.*polvo|hecho.*polvo|completamente.*destrozado|destrozado|extrañ(?:o|ar|o.*mucho)|ech(?:o|ar).*de.*menos|pérdida|\bduelo\b|ya.*no.*está|se.*fue|mur(?:ió|ió)|fallec(?:ió|ió)|falleció|despedida|despedir|abuela.*falleció|abuela.*murió|madre.*falleció|madre.*murió|padre.*falleció|padre.*murió|familiar.*falleció|familiar.*murió)/i,
        intensity: 7,
        category: 'negative'
      },
      ansiedad: {
      ...
      enojo: {
        // `ira`/`rabia` con límites: sin ellos, «respirar», «mentira», «admirar» disparaban enojo.
        patterns: /(?:enoja(?:do|da|r|rme)|\bira\b|\brabia\b|molest(?:o|a|ia|arme)|frustrad(?:o|a|r|rme)|impotencia|indignación|resentimiento|irritad(?:o|a)|furios(?:o|a)|coléric(?:o|a)|exasperad(?:o|a)|hart(?:o|a)|cansad(?:o|a).*de|fastid(?:o|a|iado|iarme)|disgustad(?:o|a)|ofendid(?:o|a)|traicionad(?:o|a)|decepcionad(?:o|a)|me.*molesta|me.*enoja|me.*irrita|me.*frustra|me.*indigna|estoy.*hart(?:o|a)|estoy.*furios(?:o|a)|me.*siento.*traicionad(?:o|a)|me.*siento.*ofendid(?:o|a)|no.*aguanto|no.*soporto|me.*tiene.*hart(?:o|a))/i,
        intensity: 8,
        category: 'negative'
      },
      alegria: {
        patterns: /(?:feliz|content(?:o|a)|alegr(?:e|ía|arme)|satisfech(?:o|a)|motivad(?:o|a)|entusiasm(?:o|ado|arme)|euforia|júbilo|optimista|esperanzad(?:o|a)|ilusionad(?:o|a)|emocionad(?:o|a)|eufóric(?:o|a)|radiante|\bgenial\b|fantástic(?:o|a)|maravillos(?:o|a)|increíble|excelente|perfect(?:o|a)|me.*siento.*bien|estoy.*bien|me.*va.*bien|todo.*va.*bien|me.*alegra|me.*encanta|me.*gusta|me.*emociona|estoy.*content(?:o|a)|estoy.*feliz|me.*siento.*feliz|me.*siento.*content(?:o|a)|me.*siento.*genial|estoy.*genial|gusta.*mucho|me.*gusta.*la|me.*gusta.*el|me.*gusta.*los|me.*gusta.*las|logr(?:é|e|ar|ado)|complet(?:é|e|ar|ado).*meta|complet(?:é|e|ar|ado).*objetivo|alcanc(?:é|e|ar|ado).*meta|alcanc(?:é|e|ar|ado).*objetivo|me.*siento.*mejor|estoy.*mejor|mejor.*que)/i,
        intensity: 7,
        category: 'positive'
      },
      miedo: {
        // `terror`/`pavor`/`temor`/`susto` con límites: evita «territorio», «pavorreal», etc.
        patterns: /(?:\bmiedo\b|\btemor\b|\bterror\b|\bpavor\b|\bsusto\b|asust(?:o|ado|ada)|atemorizad(?:o|a)|asustad(?:o|a)|aterrad(?:o|a)|aterrorizad(?:o|a)|intimid(?:ado|ada)|me.*da.*miedo|me.*asusta|me.*aterroriza|tengo.*miedo|siento.*miedo|me.*siento.*asustad(?:o|a)|estoy.*asustad(?:o|a)|me.*siento.*aterrad(?:o|a)|estoy.*aterrad(?:o|a)|tengo.*terror|siento.*terror|me.*aterroriza|me.*intimida|miedo.*de.*lo.*que|me.*aterra.*pensar|aterroriza.*pensar)/i,
        intensity: 7,
        category: 'negative'
      },
      verguenza: {
        // `pena` con límites de palabra: sin ellos, «apenas» disparaba vergüenza (falso positivo).
        patterns: /(?:vergüenza|vergonz(?:o|a|oso)|avergonzad(?:o|a)|humillad(?:o|a)|humillación|\bpena\b|apenad(?:o|a)|me.*da.*vergüenza|me.*avergüenza|me.*siento.*avergonzad(?:o|a)|estoy.*avergonzad(?:o|a)|me.*siento.*humillad(?:o|a)|estoy.*humillad(?:o|a)|me.*da.*pena|tengo.*vergüenza|siento.*vergüenza)/i,
        intensity: 6,
        category: 'negative'
      },
      culpa: {
