    ...
    try {
      ...
      res.json({
        ...
        insight: {
          ...
          abcPatterns: Array.isArray(insight?.abcPatterns) ? insight.abcPatterns : [],
          correlations: insight?.correlations || [],
          sourceSummary: insight?.sourceSummary || {},
          conductSuggestion: insight?.conductSuggestion || null,
          disclaimers: Array.isArray(insight?.disclaimers) ? insight.disclaimers : [],
          llmEnriched: insight?.llmEnriched === true,
