...
export const INTERVENTION_CATALOG = {
  ...
  // Módulos ligeros alineados a propuestas #90–#99 (catálogo #127).
  grief_roadmap: {
    id: 'grief_roadmap',
    label: 'Hoja de ruta del duelo (guía breve)',
    labelEn: 'Grief roadmap (brief guide)',
    icon: '🕯️',
    screen: null,
    type: 'micro_guide',
    tags: ['perdida', 'tristeza'],
  ...
  relapse_prevention: {
    ...
    label: 'Prevención de recaída (plan breve)',
    labelEn: 'Relapse prevention (brief plan)',
    icon: '🛡️',
    screen: null,
    type: 'micro_guide',
    tags: ['recuperacion', 'habitos'],
  },
  dbt_stop_skill: {
    id: 'dbt_stop_skill',
    label: 'Técnica STOP (regulación)',
    labelEn: 'STOP skill (regulation)',
    icon: '🛑',
    screen: null,
    type: 'micro_guide',
    tags: ['regulacion', 'enojo'],
  },
  act_values_check: {
    id: 'act_values_check',
    label: 'Revisar valores (ACT-lite)',
    labelEn: 'Values check-in (ACT-lite)',
    icon: '🧭',
    screen: null,
    type: 'micro_guide',
    tags: ['act', 'valores'],
  ...
  sleep_diary_lite: {
    id: 'sleep_diary_lite',
    label: 'Diario de sueño breve',
    labelEn: 'Brief sleep diary',
    icon: '🌙',
    screen: null,
    type: 'micro_guide',
    tags: ['sueño', 'insomnio'],
  ...
  mindfulness_sequence: {
    ...
    label: 'Secuencia mindfulness (MBSR-lite)',
    labelEn: 'Mindfulness sequence (MBSR-lite)',
    icon: '🧘',
    screen: null,
    type: 'micro_guide',
    tags: ['mindfulness', 'regulacion'],
  ...
  assertive_i_messages: {
    ...
    label: 'Mensajes yo (asertividad)',
    labelEn: 'I-messages (assertiveness)',
    icon: '💬',
    screen: null,
    type: 'micro_guide',
    tags: ['relaciones', 'asertividad'],
  ...
  problem_solving_psst: {
    ...
    label: 'Resolución de problemas (PSST)',
    labelEn: 'Problem solving (PSST)',
    icon: '🧩',
    screen: null,
    type: 'micro_guide',
    tags: ['organizacion', 'trabajo'],
