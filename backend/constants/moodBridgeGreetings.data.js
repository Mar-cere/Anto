/**
 * Copy canónico del puente mood→chat (home → chat welcome).
 * Fuente única consumida por frontend (DASH.MOOD_BRIDGE_GREETINGS) y backend.
 */
export const MOOD_BRIDGE_GREETINGS_ES = {
  calm: [
...
export const MOOD_BRIDGE_GREETINGS_EN = {
  calm: [
