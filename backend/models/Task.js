/**
 * Modelo de Tarea - Gestiona tareas, recordatorios y metas con seguimiento de progreso y notificaciones
 */
...
const taskSchema = new mongoose.Schema({
  ...
  // Fecha de completado (se establece automáticamente cuando status cambia a 'completed')
  completedAt: {
    type: Date
  },
  // Tipo de item (tarea, recordatorio o meta)
  itemType: {
    type: String,
    enum: {
...
taskSchema.pre('save', function(next) {
  ...
  // Establecer completedAt cuando el status cambia a 'completed'
...
// Métodos de instancia: operaciones sobre una tarea específica
