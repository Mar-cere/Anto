...
const DASH_HOME_KEYS = [
  ...
  'MOOD_CTA_GROUNDING',
  'MOOD_CTA_BA_TODAY',
  'MOOD_CTA_RESUME_CHAT',
  'MOOD_CTA_NEXT_HABIT',
  'MOOD_CTA_NEXT_TASK',
  'MOOD_COLLAPSED_TODAY',
  'MOOD_COLLAPSED_CALM',
  'MOOD_COLLAPSED_ANXIOUS',
  'MOOD_COLLAPSED_TIRED',
  'MOOD_COLLAPSED_GOOD',
  'MOOD_COLLAPSED_HINT',
  'MOOD_EXPAND_A11Y',
  'MOOD_COLLAPSE_A11Y',
  ...
  'STREAK_HERO_TITLE_ZERO_NAMED',
  'STREAK_HERO_TITLE_ZERO',
  'STREAK_HERO_SUBTITLE_ACTIVE',
  'STREAK_HERO_SUBTITLE_START',
  'STREAK_HERO_SUBTITLE_ZERO',
  'STREAK_HERO_MOOD_CALM_TITLE_0',
  'STREAK_HERO_MOOD_CALM_SUBTITLE_0',
  'STREAK_HERO_MOOD_ANXIOUS_TITLE_0',
  'STREAK_HERO_MOOD_ANXIOUS_SUBTITLE_0',
  'STREAK_HERO_MOOD_TIRED_TITLE_0',
  'STREAK_HERO_MOOD_TIRED_SUBTITLE_0',
  'STREAK_HERO_MOOD_GOOD_TITLE_0',
  'STREAK_HERO_MOOD_GOOD_SUBTITLE_0',
  'STREAK_HERO_ZERO_TITLE_0',
  'STREAK_HERO_ZERO_SUBTITLE_0',
  'STREAK_HERO_ACTIVE_TITLE_0',
  'STREAK_HERO_ACTIVE_SUBTITLE_0',
  'STREAK_HERO_CTA',
  'STAT_STREAK_DAYS',
  'STREAK_CHIP_ONE',
  'STREAK_CHIP_DAYS',
  'EXPLORE_SECTION_TITLE',
  'EXPLORE_SECTION_HINT',
  'STAT_HABITS_WEEK',
  'HABITS_TODAY_TITLE',
  'HABITS_VIEW_ALL',
