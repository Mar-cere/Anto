...
export const DASH = {
  ...
  QUOTE_ACTION: 'Otra',
  OFFLINE_BANNER_A11Y:
    'Sin conexion a internet. Algunas funciones pueden no estar disponibles. Revisa tu conexion.',
  OFFLINE_BANNER_TEXT:
  ...
  MOOD_SECTION_LABEL: 'Cómo llegás hoy',
  MOOD_QUESTION: '¿Cómo te sentís en este momento?',
  MOOD_CALM: 'Tranquilo',
  MOOD_ANXIOUS: 'Ansioso',
  MOOD_TIRED: 'Cansado',
  MOOD_GOOD: 'Bien',
  ANTO_PROMPT_CONTINUE: 'Continuar',
  STREAK_HERO_TITLE: 'Llevas {days} días seguidos',
  STREAK_HERO_TITLE_ONE: 'Llevas 1 día seguido',
  STREAK_HERO_TITLE_ZERO: 'Un buen momento para empezar',
  STREAK_HERO_SUBTITLE_ACTIVE: 'Eso ya es un hábito tomando forma.',
  STREAK_HERO_SUBTITLE_START: 'Cada día cuenta. Seguí así.',
  STREAK_HERO_SUBTITLE_ZERO: 'Un pequeño paso hoy puede cambiar la semana.',
  STREAK_HERO_CTA: 'Hablar con Anto',
  ...
  MOOD_ACK_CHAT_HINT: 'Anto puede acompañarte con calma si querés hablar ahora.',
