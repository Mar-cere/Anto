...
import { MOOD_BRIDGE_GREETINGS_ES } from '../moodBridgeGreetings.data.js';
...
export const DASH = {
  ...
  FOCUS_COMMITMENT_FOLLOW_UP_CHAT_EYEBROW: 'Algo que quedamos',
  FOCUS_COMMITMENT_FOLLOW_UP_CHAT_PROMPT: '¿Cómo te fue con eso?',
  ...
  MOOD_CTA_BREATHE: 'Respirar un momento',
  MOOD_CTA_CHAT_SOFT: 'Contarle a Anto',
  MOOD_CTA_GROUNDING: 'Anclarme un momento',
  MOOD_CTA_BA_TODAY: 'Mi paso de hoy',
  MOOD_CTA_RESUME_CHAT: 'Retomar el chat',
  MOOD_CTA_NEXT_HABIT: 'Mi hábito próximo',
  MOOD_CTA_NEXT_TASK: 'Mi próxima tarea',
...
export const FOCUS_PROGRESS = {
  ...
  GOAL_EMPTY_CTA: '¿Qué quieres sostener esta semana?',
  GOAL_PLACEHOLDER: 'Una cosa concreta que quieras sostener…',
  GOAL_SAVE: 'Guardar',
  GOAL_SAVING_A11Y: 'Guardando tu objetivo',
  GOAL_SAVE_ERROR: 'No se pudo guardar tu objetivo. Inténtalo de nuevo.',
  GOAL_CANCEL: 'Cancelar',
  GOAL_EDIT_A11Y: 'Editar tu objetivo',
  GOAL_EDIT_HINT: 'Toca para editar',
  GOAL_START_HINT: 'Elige un foco para escribir tu objetivo',
  GOAL_START_CTA: 'Elegir un foco',
...
export const TECHNIQUES = {
  ...
  MONTHLY_INSIGHT_EMPTY_TITLE: 'Aún no hay un informe mensual',
  MONTHLY_INSIGHT_ERROR: 'No se pudo cargar el informe mensual.',
  MONTHLY_INSIGHT_ERROR_TITLE: 'No se pudo cargar',
