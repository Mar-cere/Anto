...
export const DASH = {
  ...
  INSIGHTS_CARD_TITLE: 'Tu resumen',
  INSIGHTS_CARD_HINT: 'Actividad del período, patrones y lo que te ayuda en un solo lugar.',
  INSIGHTS_CARD_SUMMARY: 'Abrir resumen',
  INSIGHTS_CARD_SUMMARY_HINT: 'Mensajes, hábitos, patrones y técnicas que te sirven',
  INSIGHTS_CARD_A11Y: 'Tu resumen',
  ...
  EXPLORE_SECTION_HINT: 'Herramientas, diario y tu resumen cuando quieras profundizar.',
