...
const PASSWORD_INPUT_PADDING_VERTICAL = SPACING.INPUT_INSET;
const PASSWORD_INPUT_PADDING_HORIZONTAL = SPACING.INPUT_INSET;
const EYE_ICON_PADDING_HORIZONTAL = SPACING.INPUT_INSET;
