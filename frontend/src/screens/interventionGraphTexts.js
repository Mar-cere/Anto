...
const DEFAULTS = {
  ...
  ERROR_TITLE: 'No pudimos cargar el mapa',
  ERROR_HINT: 'Puede ser un problema temporal de conexión. Puedes intentarlo de nuevo.',
  RETRY: 'Reintentar',
  EMPTY: 'Aún no hay suficiente actividad. Chatea con Anto y prueba una técnica cuando te la sugiera.',
  EMPTY_TITLE: 'Aún no hay conexiones visibles',
  EMPTY_HINT:
    'Cuando charlas con Anto y pruebas técnicas, aquí verás qué temas conectan con qué te ayuda.',
  CTA_CHAT: 'Ir al chat',
  CTA_TECHNIQUES: 'Explorar técnicas',
  OPEN_TECHNIQUE: 'Abrir esta técnica',
...
const KEY_MAP = {
  ...
  ERROR_TITLE: 'INTERVENTION_GRAPH_ERROR_TITLE',
  ERROR_HINT: 'INTERVENTION_GRAPH_ERROR_HINT',
  RETRY: 'INTERVENTION_GRAPH_RETRY',
  EMPTY: 'INTERVENTION_GRAPH_EMPTY',
  EMPTY_TITLE: 'INTERVENTION_GRAPH_EMPTY_TITLE',
  EMPTY_HINT: 'INTERVENTION_GRAPH_EMPTY_HINT',
  CTA_CHAT: 'INTERVENTION_GRAPH_CTA_CHAT',
  CTA_TECHNIQUES: 'INTERVENTION_GRAPH_CTA_TECHNIQUES',
  OPEN_TECHNIQUE: 'INTERVENTION_GRAPH_OPEN_TECHNIQUE',
  LOADING: 'INTERVENTION_GRAPH_LOADING',
