...
export const LAYOUT = {
  ...
  MESSAGES_LIST_PADDING_TOP: SPACING.sm,
  MESSAGES_LIST_PADDING_BOTTOM: SPACING.sm,
  MESSAGE_CONTAINER_MARGIN_BOTTOM: 16,
  MESSAGE_BUBBLE_PADDING: SPACING.CHIP_INSET,
  MESSAGE_BUBBLE_BORDER_RADIUS: 20,
  MESSAGE_BUBBLE_MARGIN_BOTTOM: 8,
  /** Cola de burbuja: misma familia que el radio principal (evita esquina “picuda”). */
  MESSAGE_BUBBLE_CORNER_RADIUS: 12,
  INPUT_CONTAINER_PADDING_HORIZONTAL: GUTTER,
  INPUT_CONTAINER_PADDING_VERTICAL: SPACING.sm,
  /** Respiro corto sobre el home indicator (sin teclado). */
  INPUT_DOCK_PADDING_BOTTOM_EXTRA: 2,
  /** Padding inferior del dock con teclado abierto (el safe area ya no aplica). */
  INPUT_DOCK_PADDING_BOTTOM_KEYBOARD: SPACING.xs,
  INPUT_BORDER_RADIUS: 22,
  INPUT_PADDING_HORIZONTAL: SPACING.INPUT_INSET,
  INPUT_PADDING_VERTICAL: SPACING.CHIP_INSET_COMPACT,
  ...
  MODAL_PADDING: SPACING.HERO_INSET,
  MODAL_TITLE_MARGIN_BOTTOM: 16,
  MODAL_TEXT_MARGIN_BOTTOM: 24,
  MODAL_BUTTON_PADDING_HORIZONTAL: SPACING.CHIP_INSET,
  MODAL_BUTTON_PADDING_VERTICAL: SPACING.CHIP_INSET_COMPACT,
  MODAL_BUTTON_BORDER_RADIUS: 8,
  MODAL_BUTTON_MARGIN_LEFT: 12,
  TYPING_INDICATOR_PADDING_HORIZONTAL: GUTTER,
  TYPING_INDICATOR_PADDING_BOTTOM: SPACING.sm,
  ...
  GUEST_BANNER_PADDING_VERTICAL: SPACING.sm,
  GUEST_BANNER_PADDING_HORIZONTAL: GUTTER,
  EMPTY_CONTAINER_PADDING_VERTICAL: SPACING.HERO_INSET,
  /** 0: la lista de mensajes ya aplica GUTTER; no sumar otro SCREEN_EDGE. */
  EMPTY_CONTAINER_PADDING_HORIZONTAL: 0,
};
...
export function createChatColors(colors, resolvedScheme = 'light') {
  ...
  return {
    ...
    ERROR: colors.error,
    /** Legacy / tests; el header usa tint + blur, no placa opaca. */
    HEADER_BACKGROUND: colors.chromeHeader ?? colors.background,
    HEADER_BORDER: colors.chromeHeaderBorder ?? colors.border,
    HEADER_TINT_LIGHT: 'rgba(245, 247, 255, 0.28)',
    HEADER_TINT_DARK: 'rgba(8, 12, 28, 0.38)',
    HEADER_TINT_LIGHT_FALLBACK: 'rgba(245, 247, 255, 0.82)',
    HEADER_TINT_DARK_FALLBACK: 'rgba(8, 12, 28, 0.88)',
    ...
    /** Campo del composer: glass, no placa chrome opaca. */
    INPUT_FIELD_BACKGROUND: colors.glassFill ?? colors.chromeInput ?? colors.surface,
    INPUT_FIELD_BORDER: colors.glassOutline ?? colors.border,
    INPUT_PLACEHOLDER: colors.textMuted ?? colors.textSecondary,
    /** Tintes bajos: el blur solo se nota si el listado pasa por debajo del dock. */
    INPUT_DOCK_TINT_LIGHT: 'rgba(245, 247, 255, 0.26)',
    INPUT_DOCK_TINT_DARK: 'rgba(8, 12, 28, 0.4)',
    INPUT_DOCK_TINT_LIGHT_FALLBACK: 'rgba(245, 247, 255, 0.8)',
    INPUT_DOCK_TINT_DARK_FALLBACK: 'rgba(8, 12, 28, 0.88)',
    INPUT_DOCK_TOP_LINE: colors.chromeHeaderBorder ?? colors.glassOutline ?? colors.border,
    /** Send activo: primary sólido; vacío: atenuado. */
    SEND_BUTTON_BACKGROUND: colors.primary,
    SEND_BUTTON_BORDER: colors.primary,
    SEND_BUTTON_ICON: colors.textOnPrimary ?? colors.white,
    SEND_BUTTON_DISABLED_BACKGROUND:
      colors.chromeInputDisabled ?? colors.accentLineSoft ?? colors.glassFill,
    SEND_BUTTON_DISABLED_BORDER: colors.glassOutline ?? colors.border,
    SEND_BUTTON_DISABLED_ICON: colors.textMuted ?? colors.textSecondary,
