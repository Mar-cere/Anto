...
export const FILTER_PADDING_VERTICAL = SPACING.sm;
...
export const ACTION_BUTTON_PADDING_HORIZONTAL = SPACING.sm;
export const ACTION_BUTTON_PADDING_VERTICAL = SPACING.CHIP_INSET_COMPACT;
export const ACTION_BUTTON_GAP = 4;
export const ACTION_BUTTON_MARGIN_HORIZONTAL = 2;
export const ACTION_BUTTON_PADDING_RIGHT = SPACING.sm;
export const PROGRESS_INDICATOR_RIGHT = 20;
export const PROGRESS_INDICATOR_PADDING_HORIZONTAL = SPACING.HERO_INSET_COMPACT;
export const PROGRESS_INDICATOR_PADDING_VERTICAL = SPACING.CHIP_INSET;
...
export const CARD_PADDING = SPACING.HERO_INSET_COMPACT;
...
export const ERROR_CONTAINER_PADDING = SPACING.CARD_INNER_INSET;
export const ERROR_CONTAINER_GAP = 16;
export const RETRY_BUTTON_PADDING_HORIZONTAL = SPACING.CHIP_INSET;
export const RETRY_BUTTON_PADDING_VERTICAL = SPACING.CHIP_INSET;
export const RETRY_BUTTON_BORDER_RADIUS = 12;
export const EMPTY_CONTAINER_PADDING = SPACING.xl;
export const EMPTY_CONTAINER_GAP = 16;
export const ADD_FIRST_BUTTON_PADDING_HORIZONTAL = SPACING.HERO_INSET_COMPACT;
export const ADD_FIRST_BUTTON_PADDING_VERTICAL = SPACING.CHIP_INSET;
