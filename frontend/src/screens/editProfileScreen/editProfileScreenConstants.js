...
export const CONTENT_PADDING_BOTTOM = SPACING.xxl;
export const HEADER_PADDING_HORIZONTAL = SPACING.SCREEN_EDGE_INSET;
...
export const INPUT_PADDING_VERTICAL = SPACING.INPUT_INSET;
export const INPUT_BORDER_WIDTH = 1;
export const ERROR_TEXT_MARGIN_TOP = 4;
export const HELPER_TEXT_MARGIN_TOP = 4;
export const PROFILE_HEADER_PADDING_VERTICAL = SPACING.HERO_INSET;
...
export const INPUT_WRAPPER_PADDING_HORIZONTAL = SPACING.INPUT_INSET;
export const LOADING_TEXT_MARGIN_TOP = 10;
export const SAVE_SUCCESS_PADDING_HORIZONTAL = SPACING.HERO_INSET;
export const SAVE_SUCCESS_PADDING_VERTICAL = SPACING.CHIP_INSET_COMPACT;
