  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        weekLoading: { alignItems: 'center', paddingVertical: SPACING.HERO_INSET },
        weekRoot: { gap: SPACING.CARD_INNER_INSET },
        ...
        weekSlotTop: { flexDirection: 'row', alignItems: 'flex-start', gap: SPACING.CHIP_INSET },
        weekDayBadge: {
          minWidth: 44,
          height: 44,
          borderRadius: 14,
        ...
        weekStatusPill: { borderRadius: 999, paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs },
