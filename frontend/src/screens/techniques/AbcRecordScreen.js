...
const DEFAULT_TEXTS = {
  ...
  DELETE_CONFIRM_TITLE: 'Eliminar registro ABC',
  ...
  const TEXTS = useMemo(
    () => ({
      ...
      DELETE_CONFIRM_TITLE:
        translated?.ABC_DELETE_CONFIRM_TITLE || DEFAULT_TEXTS.DELETE_CONFIRM_TITLE,
      DELETE_CONFIRM_MESSAGE:
        translated?.ABC_DELETE_CONFIRM_MESSAGE || DEFAULT_TEXTS.DELETE_CONFIRM_MESSAGE,
