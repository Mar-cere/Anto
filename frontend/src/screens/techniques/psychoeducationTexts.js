...
const DEFAULTS = {
  ...
  CARD_CTA_COMPACT: 'Abrir',
  CARD_MINUTES: '~{n} min',
  CARD_MICROSTEP_PROGRESS: '{done}/{total} pasos probados',
  CARD_MICROSTEP_A11Y: 'Marcar paso {n} como probado',
...
const KEY_MAP = {
  ...
  CARD_CTA_COMPACT: 'PSYCHOED_CARD_CTA_COMPACT',
  CARD_MINUTES: 'PSYCHOED_CARD_MINUTES',
  CARD_MICROSTEP_PROGRESS: 'PSYCHOED_CARD_MICROSTEP_PROGRESS',
  CARD_MICROSTEP_A11Y: 'PSYCHOED_CARD_MICROSTEP_A11Y',
  REVIEW_FOOTER: 'PSYCHOED_REVIEW_FOOTER',
  REVIEW_SEAL_HEADLINE: 'PSYCHOED_REVIEW_SEAL_HEADLINE',
  REVIEW_SEAL_SHORT: 'PSYCHOED_REVIEW_SEAL_SHORT',
  REVIEW_STATUS_EDITORIAL: 'PSYCHOED_REVIEW_STATUS_EDITORIAL',
  REVIEW_STATUS_CLINICAL: 'PSYCHOED_REVIEW_STATUS_CLINICAL',
